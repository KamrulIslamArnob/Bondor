...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="w-full pt-6 pb-16 text-center space-y-10">
      {/* Top Main Headline with Blue Keyword Accent */}
      <div className="max-w-4xl mx-auto space-y-4 px-4">
        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-slate-900 tracking-tight leading-[1.1] text-balance">
          Launch local,{" "}
          <span className="text-blue-600">manufacture global</span>
        </h1>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3.5 text-left">
          {categories.map((cat) => (
            <Link
              key={cat.id}
              href={cat.href}
              className="group bg-slate-50/80 hover:bg-white border border-slate-200/80 hover:border-blue-300 rounded-2xl p-4 transition-all duration-200 shadow-xs hover:shadow-card hover:-translate-y-0.5 flex flex-col justify-between"
            >
      ...
      <div className="max-w-md mx-auto px-4 space-y-3">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <button
            ...
            className="w-full sm:w-auto px-7 py-3.5 bg-blue-600 hover:bg-blue-700 active:scale-[0.96] text-white font-bold rounded-xl text-sm transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 cursor-pointer"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-6 py-3.5 bg-white hover:bg-slate-50 active:scale-[0.96] text-slate-800 border border-slate-300 font-bold rounded-xl text-sm transition-all shadow-xs flex items-center justify-center gap-2 cursor-pointer"
          >
        ...
        <p className="text-xs text-slate-500 font-medium">
          Instant 1-Click Access · No credit card required.
        </p>
      </div>
