      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        <div className="lg:col-span-6 flex items-center justify-center">
          <div className="relative w-full max-w-md aspect-square rounded-3xl bg-gradient-to-br from-blue-50 via-sky-50 to-indigo-50 border border-slate-200/90 p-8 flex items-center justify-center shadow-card">
            {/* Center Score Badge */}
            <div className="w-36 h-36 rounded-3xl bg-white shadow-card border border-blue-200/80 p-4 flex flex-col items-center justify-center text-center space-y-1 z-10">
            ...
            <img
              ...
              alt="Artisan maker"
              className="absolute top-6 left-6 w-14 h-14 rounded-2xl object-cover border-2 border-white shadow-md"
            />
            <img
              src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=150&q=80"
              alt="Artisan maker"
              className="absolute top-6 right-6 w-14 h-14 rounded-2xl object-cover border-2 border-white shadow-md"
            />
            <img
              src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=150&q=80"
              alt="Artisan maker"
              className="absolute bottom-6 left-6 w-14 h-14 rounded-2xl object-cover border-2 border-white shadow-md"
            />
            <img
              src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80"
              alt="Wholesale supplier"
              className="absolute bottom-6 right-6 w-14 h-14 rounded-2xl object-cover border-2 border-white shadow-md"
            />
          </div>
        </div>
