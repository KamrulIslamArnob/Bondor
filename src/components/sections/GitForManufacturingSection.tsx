        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="space-y-3 text-xs sm:text-sm font-semibold text-slate-800">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-blue-600 hover:underline cursor-pointer">Work on multiple craft docks</span>
              <span className="text-slate-600 font-normal">in parallel (Tees, Candles, Soaps)</span>
            </div>
            <div className="flex items-center gap-2.5">
              <span className="text-blue-600">►</span>
              <span className="text-slate-900 font-bold">Track ingredient changes</span>
              <span className="text-slate-600 font-normal">and revert formulations if needed</span>
            </div>
            <div className="flex items-center gap-2.5">
              <span className="text-blue-600">►</span>
              <span className="text-blue-600 hover:underline cursor-pointer">Connect masterclass lessons</span>
              <span className="text-slate-600 font-normal">directly with verified supply kits</span>
            </div>
          </div>
        ...
        <div className="lg:col-span-6">
          <div className="relative aspect-[4/3] rounded-3xl bg-gradient-to-br from-slate-50 via-blue-50/40 to-slate-100 border border-slate-200/90 p-6 sm:p-8 shadow-card flex flex-col justify-between">
            ...
            <div className="space-y-4 py-3">
              ...
              <div className="flex items-center gap-3 bg-white p-3 rounded-2xl border border-slate-200/80 shadow-xs">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-slate-900">Emulsion &amp; Darkroom Exposure</span>
              ...
              {/* Branch 2 */}
              <div className="flex items-center gap-3 bg-white p-3 rounded-2xl border border-slate-200/80 shadow-xs ml-4">
                <div className="w-8 h-8 rounded-full bg-amber-100 text-amber-600 flex items-center justify-center font-bold text-xs">
                  02
                </div>
                <div className="min-w-0 flex-1">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-slate-900">Wholesale Combed Cotton Batch</span>
                    <span className="text-[10px] text-blue-600 font-semibold">50 Blanks Received</span>
                  </div>
              ...
              {/* Branch 3 */}
              <div className="flex items-center gap-3 bg-white p-3 rounded-2xl border border-blue-300 shadow-xs">
